...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Multi-Agent Delivery Simulation")
    ...
    parser.add_argument("--map", type=str, default="map.txt", help="Map file name")
    ...
    plt.plot(range(1, t+1), rewards, label='Reward per step')
    plt.xlabel('Timestep')
    plt.ylabel('Reward')
